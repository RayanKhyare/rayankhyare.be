...
export default function Home() {
  return (
    <>
      ...
      <p className="introduction">Hi there! I’m a passionate web developer specializing in creating stunning and user-friendly websites. At 21 years old, I'm in my first year of professional experience, and I thrive on the thrill of learning new technologies and techniques. I'm always eager for opportunities to expand my skills and deliver exceptional digital experiences.</p>
